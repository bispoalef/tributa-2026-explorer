...
const Simulador = () => {
  ...
  const calcular = () => {
    ...
    let aliquota = 0.12; // padrão CBS 12%

    if (form.situacaoTributaria === "06") aliquota = 0.0;
    if (form.classificacaoTrib === "Imune" || form.classificacaoTrib === "Isento")
      aliquota = 0.0;
      ...
      <main className="container mx-auto px-4 py-12">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    handleChange("situacaoTributaria", v)
                  }
                >
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="rounded-lg bg-muted/30 p-4">
                      ...
                      <div className="text-2xl font-bold text-foreground">
                        R$ {result.valorBase.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="text-3xl font-bold text-blue-600">
                        R$ {result.valorTributo.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                      </div>
                    </div>
                  </div>
                </Card>
        ...
        <Card className="mt-8 border-l-4 border-l-secondary p-6">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            ou especialista tributário para análises detalhadas.
          </p>
        </Card>
      </main>
